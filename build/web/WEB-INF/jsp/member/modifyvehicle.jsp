<%-- 
    Document   : modifyvehicle
    Created on : 20.12.2015, 16:06:31
...
<html>
    <head>
        ...
        <title><fmt:message key="title.vehicles"/></title>
        ...
        <div class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#" style="font-size: 32px;"><fmt:message key="title.general"/> >> <fmt:message key="modveh"/></a>
                </div>
                <div class="collapse navbar-collapse">
                    ...
                    <c:if test="${not empty messageResult}">
                        <div class="alert alert-success alert-dismissable col-md-5" style="position:absolute; left:400px; top:37px; z-index:0">
                            ...
                            <strong>Operation succesful: </strong><c:out value="${messageResult}"/>
                        </div>
                    </c:if>
                    ...
                    <c:if test="${not empty messageError}">
                        <div class="alert alert-danger alert-dismissable col-md-5" style="position:absolute; left:400px; top:37px; z-index:0">
                            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                            <strong>Operation failed: </strong><c:out value="${messageError}"/>
                        </div>
                    </c:if>
                </div><!--/.nav-collapse -->
            </div>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="text-muted bootstrap-admin-box-title">
                                        <strong><fmt:message key="modvehdata"/>:</strong>
                                    </div>
                                ...
                                <div class="bootstrap-admin-panel-content" style="height: 400px;">
                                    ...
                                    <form class="form-horizontal" action="controller" method="post">
                                        <div class="modal-body">
                                            <input type="hidden" name="command" value="cModifyVehicle"/>
                                            <input type="hidden" name="idvehicle" value="${idvehicle}"/>
                                            <label class="col-lg-2 control-label" for="idvehicle"><fmt:message key="vehid"/>:</label>
                                            <div class="input-group col-lg-9">
                                                <input type="text" id="idvehicle" class="form-control" value="${idvehicle}" disabled>
                                            </div>
                                            <br>
                                            <label class="col-lg-2 control-label" for="mark"><fmt:message key="mark"/>:</label>
                                            <div class="input-group col-lg-9">
                                                <input type="text" name="mark" id="mark" class="form-control" value="${markvehicle}">
                                            </div>
                                            <br>
                                            <label class="col-lg-2 control-label" for="model">model:</label>
                                            <div class="input-group col-lg-9">
                                                <input type="text" name="model" id="model" class="form-control" value="${modelvehicle}"> 
                                            </div>
                                            <br>
                                            <label class="col-lg-2 control-label" for="status"><fmt:message key="status"/>:</label>
                                            <div class="input-group col-lg-9">
                                                <input type="text" name="status" id="status" class="form-control" value="${statusvehicle}">
                                            </div>
                                            <br>
                                        ...
                                        <div class="modal-footer">
                                            <input type="submit" name="modifyvehicle" id="modifyvehicle" tabindex="1" class="btn btn-success" value="<fmt:message key="modvehzas"/>" style="margin-right: 75px;">
                                        </div>
                                    </form>

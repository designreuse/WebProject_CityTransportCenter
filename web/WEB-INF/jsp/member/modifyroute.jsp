<%-- 
    Document   : modifyroute
    Created on : 20.12.2015, 20:55:58
        ...
        <div class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#" style="font-size: 32px;"><fmt:message key="title.general"/> >> <fmt:message key="modroute"/></a>
                </div>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="text-muted bootstrap-admin-box-title">
                                        <strong><fmt:message key="modroutedata"/>:</strong>
                                    </div>

                                </div>
                                <div class="bootstrap-admin-panel-content" style="height: 390px;">
                                    <br>
                                    <br>
                                    <form class="form-horizontal" action="controller" method="post">
                                        <div class="modal-body">
                                            <input type="hidden" name="command" value="cModifyRoute"/>
                                            <input type="hidden" name="idroute" value="${idroute}"/>
                                            <label class="col-lg-2 control-label" for="idroute"><fmt:message key="rid"/>:</label>
                                            <div class="input-group col-lg-9">
                                                <input type="text" name="idroute" id="idroute" class="form-control" value="${idroute}" disabled>
                                            </div>
                                            <br>
                                            <label class="col-lg-2 control-label" for="routename"><fmt:message key="name"/>:</label>
                                            <div class="input-group col-lg-9">
                                                <input type="text" name="routename" id="routename" class="form-control" value="${routename}">
                                            </div>
                                            <br>
                                            <label class="col-lg-2 control-label" for="description"><fmt:message key="descr"/>:</label>
                                            <div class="input-group col-lg-9">
                                                <input type="text" name="description" id="description" class="form-control" value="${routedescription}"> 
                                            </div>
                                        </div>
                                        <div class="modal-footer">
                                            <input type="submit" name="modifyvehicle" id="modifyvehicle" tabindex="1" class="btn btn-success" value="<fmt:message key="modroute"/>" style="margin-right: 75px;">
                                        </div>
                                    </form>

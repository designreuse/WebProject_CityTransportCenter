<%-- 
    Document   : timemaps
    Created on : 13.12.2015, 17:34:52
...
<html lang="en">
    <head>
        ...
        <title><fmt:message key="title.intervals"/></title>
        ...
        <div class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#" style="font-size: 32px;"><fmt:message key="title.general"/> >> <fmt:message key="intervals"/></a>
                </div>
                        ...
                        <ul class="dropdown-menu">
                            <li><a><img src="./styles/pics/flags/Ukraine.png" height="20" width="20">
                                    <form name="setLangForm" method="POST" action="controller" style="display: inline-block">
                                        ...
                                        <input type="hidden" name="backcommand" value="cTimeMaps"/>
                            ...
                            <li>
                                <a>
                                    <form name="exportForm" method="POST" action="controller">
                                        <input type="hidden" name="command" value="cExportTimeIntervals"/>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="text-muted bootstrap-admin-box-title">
                                        <table class="table bootstrap-admin-table-with-actions">
                                            <thead>
                                                <tr>
                                                    <th style="width:7%;"><fmt:message key="id"/></th>
                                                    <th style="width:11%;"><fmt:message key="direct"/></th>
                                                    <th style="width:13%;"><fmt:message key="from"/></th>
                                                    <th style="width:13%;"><fmt:message key="to"/></th>
                                                    <th style="width:13%;"><fmt:message key="interval"/></th>
                                                    <th style="width:16%;"><fmt:message key="routeref"/></th>
                                                    <th><fmt:message key="act"/></th>
                                                    <th align="right">
                                                        <form name="newTimeintervalForm" method="POST" action="controller">
                                                        <input type="hidden" name="command" value="cTimeIntervalCreationForm"/>
                                                        <button class="btn btn-sm btn-success" type="submit" style="margin-left: 45px;"><i class="glyphicon glyphicon-ok-sign"></i><fmt:message key="newint"/></button>
                                                        </form>
                                                    </th>
                                                </tr>
                                            </thead>
                                ...
                                <div class="bootstrap-admin-panel-content" style="height: 400px; overflow-y: scroll;">
                                    <table class="table table-hover bootstrap-admin-table-with-actions">
                                        ...
                                        <tbody>
                                            <c:forEach var="timeinterval" items="${timetablelist}">
                                                <tr>
                                                    <td align="center"><c:out value="${timeinterval.ttid}"/></td>
                                                    <td align="left"><c:out value="${timeinterval.direction}"/></td>
                                                    <td align="left"><c:out value="${timeinterval.startPoint}"/></td>
                                                    <td align="left"><c:out value="${timeinterval.endPoint}"/></td>
                                                    <td align="left"><c:out value="${timeinterval.interval}"/></td>
                                                    <td align="left"><c:out value="${timeinterval.routename}"/></td>
                                                    <td class="actions" align="right">
                                                        <form class="form-horizontal" name="delIntervalForm" method="POST" action="controller" style="display: inline-block">
                                                            <input type="hidden" name="command" value="cDeleteInterval"/>
                                                            <input type="hidden" name="iddelinterval" value="${timeinterval.ttid}">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel"><fmt:message key="crnewint"/></h4>
                    </div>
                    <form class="form-horizontal" action="controller" method="post">
                        ...
                        <div class="modal-footer">
                            <input type="submit" name="createroute" id="createroute" tabindex="1" class="btn btn-success" value="<fmt:message key="crnewint"/>">
